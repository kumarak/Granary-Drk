...
# 1 "kernel_types.hpp"
# 13 "kernel_types.hpp"
# 1 "/usr/local/lib/gcc/x86_64-unknown-linux-gnu/4.6.4/include/stdbool.h" 1 3 4
# 14 "kernel_types.hpp" 2
...
typedef void ( * rcu_func ) ( struct rcu_head * rcu );

extern int call_rcu ( struct rcu_head * head , rcu_func func ) ;

extern void* rcu_watch_assign_pointer(void **dest, void *src, const char *loc);
extern void rcu_watch_read_lock(const char *loc);
extern void rcu_watch_read_unlock(const char *loc);
extern void rcu_watch_read_lock_bh(const char *loc);
extern void rcu_watch_read_unlock_bh(const char *loc);
extern void rcu_watch_read_lock_sched(const char *loc);
extern void rcu_watch_read_unlock_sched(const char *loc);
extern void *rcu_watch_dereference(void *addr, const char *loc);
extern void *rcu_watch_alloc_(void *addr, const char *loc);
extern void *rcu_watch_free_(void *addr, const char *loc);
