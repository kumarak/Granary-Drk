...
def get_func_symbol_names(host_file_name, client_file_name):
    ...
    try:
        ...
        pass
    return get_symbol_addr, get_symbol_gpl_addr, vmalloc_area_addr, printk_addr, names

if __name__ == "__main__":
    addr, gpl_addr, vmalloc_addr, printk_addr, syms = get_func_symbol_names("host_map.txt", "client_map.txt")
...
""" % (addr, gpl_addr, vmalloc_addr, printk_addr))
